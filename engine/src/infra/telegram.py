...
class TelegramAlerter:
    ...
    async def send_fill_kr(self, data: dict[str, Any]) -> bool:
        ...
        lines = [
            ...
            "",
            f"<b>전략:</b> {_html.escape(str(data.get('strategy', 'N/A')))}",
            f"<b>심볼:</b> {_html.escape(str(data.get('symbol', 'N/A')))}",
            f"<b>매수:</b> {_html.escape(str(data.get('buy_exchange', 'N/A')))}",
            f"<b>매도:</b> {_html.escape(str(data.get('sell_exchange', 'N/A')))}",
