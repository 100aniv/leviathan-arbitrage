"""Bybit linear futures public orderbook collector via native WebSocket."""
...
class BybitFuturesCollector(BaseCollector):
    """Collects Bybit linear futures orderbook data via the public V5 WebSocket.

    Endpoint: wss://stream.bybit.com/v5/public/linear  (spot uses /spot)
    ...
    def _subscribe_message(self, symbol: str) -> str | dict:
        """Build the Bybit V5 subscribe frame for one futures symbol."""
