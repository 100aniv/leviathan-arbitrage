"""Tests for ExecutionMode, CapitalTierConfig, ExecutionSettings (via src/core/config.py)."""
...
class TestCapitalTierConfig:
    def test_default_tier_is_alpha(self):
        from src.core.config import CapitalTierConfig
...
class TestExecutionSettings:
    ...
    def test_capital_field_is_capital_tier_config(self):
        from src.core.config import Settings, CapitalTierConfig
        settings = Settings()
