...
class TestDefaultConfiguration:
    def test_default_exchanges_list_contains_eight_exchanges(self):
        assert CollectorManager.DEFAULT_EXCHANGES == ["binance", "bybit", "okx", "bitget", "upbit", "bithumb", "coinone", "binance_futures"]
